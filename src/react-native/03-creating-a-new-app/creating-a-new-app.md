...
<img alt="A mobile phone displaying the root page of the newly created application served by the dev server. The page displays a “Place My Order: Coming Soon!” message." src="../static/img/react-native/03-creating-a-new-app/02-solution.png" style="border: 4px solid black; border-radius: 25px;" width="638px"/>
