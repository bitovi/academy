...
If you're looking for an IDE to improve your Angular development - VS Code is widely used by the community but editors like Atom and Webstorm are fine as well. Plugins can go a long way in aiding the development process.
